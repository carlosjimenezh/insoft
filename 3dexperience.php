    ...
    <section id='matriz' class="contenido" style="margin-top: 150px; overflow-x:auto">
        <table> 
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        Generación avanzada de superficies
                    </td>
                    <td class="able"> <strong>o</strong> </td>
                    <td class="espacio"></td>
                    <td class="able"> <strong>o</strong> </td>
                ...
                <tr>
                    <td>
                        Herramientas de diseño de chapa metálica                   
                    </td>
                    <td class="able"> <strong>o</strong> </td>
                    <td class="espacio"></td>
                    <td class="able"> <strong>o</strong> </td>
                ...
                <tr>
                    <td>
                        Herramientas de diseño de moldes                   
                    </td>
                    <td class="able"> <strong>o</strong> </td>
                    <td class="espacio"></td>
                    <td class="able"> <strong>o</strong> </td>
                ...
                <tr>
                    <td>
                        Gestión de grandes Ensamblajes
                    </td>
                    <td class="able"> <strong>o</strong> </td>
                    <td class="espacio"></td>
                    <td class="able"> <strong>o</strong> </td>
                ...
                <tr>
                    <td>
                        Automatización del diseño en tareas repetitivas
                    </td>
                    <td class="able"> <strong>o</strong> </td>
                    <td class="espacio"></td>
                    <td class="able"> <strong>o</strong> </td>
                ...
                <tr>
                    <td>
                        Bibliotecas de hardware estándar
                    </td>
                    <td class="disable"> <strong>x</strong> </td>
                    <td class="espacio"></td>
                    <td class="able"> <strong>o</strong> </td>
                ...
                <tr>
                    <td>
                        Procesamiento de fotografías realistas                   
                    </td>
                    <td class="disable"> <strong>x</strong> </td>
                    <td class="espacio"></td>
                    <td class="able"> <strong>o</strong> </td>
                ...
                <tr>
                    <td>
                        Comprobación de estándares de diseño
                    </td>
                    <td class="disable"> <strong>x</strong> </td>
                    <td class="espacio"></td>
                    <td class="able"> <strong>o</strong> </td>
                ...
                <tr>
                    <td>
                        Utilización de datos escaneados
                    </td>
                    <td class="disable"> <strong>x</strong> </td>
                    <td class="espacio"></td>
                    <td class="disable"> <strong>x</strong> </td>
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        Búsqueda y reutilización de datos de diseño
                    </td>
                    <td class="disable"> <strong>x</strong> </td>
                    <td class="espacio"></td>
                    <td class="disable"> <strong>x</strong> </td>
                ...
                <tr>
                    <td>
                        Vista preliminar completa del documento
                    </td>
                    <td class="disable"> <strong>x</strong> </td>
                    <td class="espacio"></td>
                    <td class="disable"> <strong>x</strong> </td>
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        Predicción de errores del producto
                    </td>
                    <td class="disable"> <strong>x</strong> </td>
                    <td class="espacio"></td>
                    <td class="able"> <strong>o</strong> </td>
                ...
                <tr>
                    <td>
                        Comparación y optimización de alternativas
                    </td>
                    <td class="disable"> <strong>x</strong> </td>
                    <td class="espacio"></td>
                    <td class="able"> <strong>o</strong> </td>
                ...
                <tr>
                    <td>
                        Simulación de calentamiento o enfriamiento
                    </td>
                    <td class="disable"> <strong>x</strong> </td>
                    <td class="espacio"></td>
                    <td class="able"> <strong>o</strong> </td>
                ...
                <tr>
                    <td>
                        Simulación de estudios de choque o fallos de producción
                    </td>
                    <td class="disable"> <strong>x</strong> </td>
                    <td class="espacio"></td>
                    <td class="able"> <strong>o</strong> </td>
                ...
                <tr>
                    <td>
                        Simulación de cargas repetitivas
                    </td>
                    <td class="disable"> <strong>x</strong> </td>
                    <td class="espacio"></td>
                    <td class="able"> <strong>o</strong> </td>
                ...
                <tr>
                    <td>
                        Simulación de piezas de plástico
                    </td>
                    <td class="disable"> <strong>x</strong> </td>
                    <td class="espacio"></td>
                    <td class="disable"> <strong>x</strong> </td>
