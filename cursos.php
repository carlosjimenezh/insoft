...
<body id="capacitacion">
    ...
    <section id="cursos">
        <div class="w3-row contenido centrar-small" style="max-width: 900px">
            <div class="cflex">
    ...
    <a name="scontacto-cursos"></a>
        ...
        <form action="<?php $dir;?>?a=2#scontacto-cursos" class="contenido" name="contacto-cursos" id="contacto-cursos" method="POST">
            <div class="w3-row">
        ...
        <div class="lnazul">
            ...
            height:10px; width:240px">
                <a onclick="verifica('contacto-cursos')" class="btn flotante">Enviar</a>
            </div>
        </div>
        <?php
	    }?>
